...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private int quantity; // для изменения кол-ва смен
    private double salary;//зарплата в час
    private String textSalary = " руб./час";
    private String positionsName;//выбор спинера
    private int twelveHourShift = 12; //смена 12 часов
    private int nineHourShift = 8; //смена 8 часа
    private int fourHourShift = 4; //смена 4 часа
    ...
    void sendingReport(){
        ...
        buttonGenerateReport.setOnClickListener(view -> {
...
//                order.oneMonthSalary = quantity * salary * twelveHourShift;
    ...
    void createSpinner(){
        ...
        adapterListPositions = new ArrayAdapter<>(this,android.R.layout.simple_spinner_item, listPositions);
